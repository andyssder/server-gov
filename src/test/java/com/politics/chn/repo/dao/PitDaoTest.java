...
class PitDaoTest {
    ...
    void getByDistrictLevel() {
        PitPO pitPO1 = new PitPO("test-getByDistrictLevel1", "",100, 1, 10, 10000000,10000003);
        PitPO pitPO2 = new PitPO("test-getByDistrictLevel2",101, 2, 11, 10000001,10000002);
    ...
    @Test
    void getOneById() {
        PitPO pitPO = new PitPO("test-getOneById", "",1, 1, 1, 1, 100);
    ...
    @Test
    void insertOne() {
        PitPO pitPO = new PitPO("test-insertOne", "",1, 1, 1, 1, 100);
    ...
    @Test
    void updateOne() {
        PitPO pitPO = new PitPO("test-updateOne", "",1, 1, 1, 1, 100);
        PitPO targetPitPO = new PitPO("test-updated", "test",2, 1, 1, 1, 100);
        pitDao.insertOne(pitPO);
    ...
    @Test
    void deleteOne() {
        PitPO pitPO = new PitPO("delete-test", "",1, 1, 1, 0, 0);
        pitDao.insertOne(pitPO);
